...
namespace Fluxo.GtkUI
{
    public class MainWindow : Window, IApplicationWindow
    {
        ...
        public MainWindow() : base("Fluxo")
        {
            SetDefaultIconFromFile(IoPath.Combine(AppDomain.CurrentDomain.BaseDirectory, "fluxo-logo-512.png"));
            ...
            statusIcon = new StatusIcon(GtkHelper.LoadSvg("fluxo-logo", 128));
        ...
        {
            using var win = Fluxo.GtkUI.Dialogs.About.AboutDialog.CreateFromGladeFile(this, windowGroup);
            win.Run();
            win.Destroy();
        }
        ...
        {
            if (!GtkHelper.ShowConfirmMessageBox(this, TextResource.GetText("MENU_DELETE_COMPLETED"), "Fluxo"))
            {
                return;
            }
