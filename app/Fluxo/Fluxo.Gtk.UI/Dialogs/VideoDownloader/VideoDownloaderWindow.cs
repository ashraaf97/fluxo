...
using TraceLog;
using Fluxo.Core.UI;
using Fluxo.GtkUI.Dialogs.AdvancedDownload;

namespace Fluxo.GtkUI.Dialogs.VideoDownloader
{
    public class VideoDownloaderWindow : Window, IVideoDownloadView
    {
        ...
        private VideoDownloaderWindow(Builder builder) : base(builder.GetRawOwnedObject("window"))
        {
            ...
            {
                if (GtkHelper.ShowConfirmMessageBox(this, TextResource.GetText("MSG_HELPER_TOOLS_MISSING"), "Fluxo"))
                {
