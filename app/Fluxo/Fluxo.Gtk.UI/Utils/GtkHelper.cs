...
namespace Fluxo.GtkUI.Utils
{
    internal static class GtkHelper
    {
        ...
        {
            using var fc = new FileChooserNative("Fluxo", parent, FileChooserAction.SelectFolder, 
            ...
            //using var fc = new FileChooserDialog("Fluxo", parent, FileChooserAction.SelectFolder);
            //try
            //{
        ...
        {
            using var fc = new FileChooserNative("Fluxo", parent, FileChooserAction.Open,
                TextResource.GetText("MSG_SELECT_FOLDER"), TextResource.GetText("ND_CANCEL"));
            if (fc.Run() == (int)ResponseType.Accept)
            {
                return fc.Filename;
            ...
            //using var fc = new FileChooserDialog("Fluxo", parent, FileChooserAction.Open);
            //try
            //{
            //    if (parent.Group != null)
            //    {
        ...
        {
            using var fc = new FileChooserNative("Fluxo", parent, FileChooserAction.Save,
            ...
            //using var fc = new FileChooserDialog("Fluxo", parent, FileChooserAction.Save);
            //if (!string.IsNullOrEmpty(path))
            //{
            //    var dir = Path.GetDirectoryName(path);
            //    fc.SetFilename(Path.GetFileName(path));
