...
robocopy ..\Fluxo.Wpf.UI\bin\x86\Release\net4.7.2 net4.7.2 /E

heat dir net4.7.2 -o net4.7.2.wxs -scom -frag -srd -sreg -gg -cg NET472 -dr INSTALLFOLDER

candle product.wxs net4.7.2.wxs
light -ext WixUIExtension -ext WixUtilExtension -cultures:en-us product.wixobj net4.7.2.wixobj -b net4.7.2 -out fluxosetup.msi
