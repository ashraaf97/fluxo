...
xcopy /E ..\chrome-extension BIN\chrome-extension
xcopy /E ..\ext-loader BIN\ext-loader

heat dir BIN -o net4.6.0.wxs -scom -frag -srd -sreg -gg -cg NET460 -dr INSTALLFOLDER

candle silent.wxs net4.6.0.wxs
light -ext WixUIExtension -ext WixUtilExtension -cultures:en-us silent.wixobj net4.6.0.wixobj -b BIN -out fluxosetup-%BUILD_VER%-x86.msi
