...
namespace Fluxo.Core.BrowserMonitoring
{
    public class NativeMessagingHostHandler : IDisposable
    {
        ...
        private static readonly string PipeName = "Fluxo_Ipc_Browser_Monitoring_Pipe";
        ...
        public static void EnsureSingleInstance()
        {
            try
            {
                ...
                throw new InstanceAlreadyRunningException(@"Fluxo instance already running, Mutex exists 'Global\Fluxo_Active_Instance'");
            }
            catch (Exception ex)
            {
            ...
            globalMutex = new Mutex(true, @"Global\Fluxo_Active_Instance");
        }
        ...
        //        if (clientPipeName.StartsWith("Fluxo-ApplicationContext.Core-"))
        //        {
