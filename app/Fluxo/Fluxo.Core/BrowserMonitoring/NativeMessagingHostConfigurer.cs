...
//namespace Fluxo.Core.BrowserMonitoring
//{
...
//                        @"microsoft\windowsapps\fluxo-app-host.exe");
//            }
//            return Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Fluxo.App.Host" + Path.DirectorySeparatorChar + "fluxo-app-host" + (
...
//        {
//            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "fluxo-app-host.bat");
//        }
...
//            try
//            {
//                using var regKey = Registry.CurrentUser.OpenSubKey(@"SOFTWARE\Google\Chrome\NativeMessagingHosts\fluxo_chrome.native_host");
//                var path = (string)regKey.GetValue(null);
//                if (path == Path.Combine(AppDomain.CurrentDomain.BaseDirectory, Path.Combine("Fluxo.App.Host", "fluxo_chrome.native_host.json")))
//                {
//                    return true;
//                }
//            }
...
//            try
//            {
//                using var regKey = Registry.CurrentUser.OpenSubKey(@"Software\Mozilla\NativeMessagingHosts\fluxoff.native_host");
//                var path = (string)regKey.GetValue(null);
//                if (path == Path.Combine(AppDomain.CurrentDomain.BaseDirectory, Path.Combine("Fluxo.App.Host", "fluxoff.native_host.json")))
//                {
//                    return true;
//                }
//            }
