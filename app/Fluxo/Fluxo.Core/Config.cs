    ...
    public class Config
    {
        ...
        public static void LoadConfig(string? path = null)
        {
            ...
            DataDir = path ?? Path.Combine(
                Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), ".fluxo-app-data"), "Data");
            AppDir = path ??
                Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), ".fluxo-app-data");
#else

            DataDir = path ?? Path.Combine(
                Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".fluxo-app-data"), "Data");
            AppDir = path ?? Path.Combine(
                Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".fluxo-app-data"));
#endif
            instance = new Config
            {
        ...
        //{
        //    instance.AfterCompletionCommand = Fluxo.Messaging.StreamHelper.ReadString(r);
        //    instance.AntiVirusArgs = Fluxo.Messaging.StreamHelper.ReadString(r);
        //    instance.AntiVirusExecutable = Fluxo.Messaging.StreamHelper.ReadString(r);
        ...
        //        {
        //            DefaultFolder = Fluxo.Messaging.StreamHelper.ReadString(r),
        //            DisplayName = Fluxo.Messaging.StreamHelper.ReadString(r),
        //            FileExtensions = new HashSet<string>(),
        //        };
        //        var c2 = r.ReadInt32();
        //        for (int j = 0; j < c2; j++)
        ...
        //    instance.DefaultDownloadFolder = Fluxo.Messaging.StreamHelper.ReadString(r);
        ...
        //    instance.TempDir = Fluxo.Messaging.StreamHelper.ReadString(r);
        //    count = r.ReadInt32();
        ...
        //            User = Fluxo.Messaging.StreamHelper.ReadString(r),
