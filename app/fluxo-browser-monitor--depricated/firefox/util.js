...
fluxo.util = {
    ...
    isBlocked: function (url) {
        var blockedHosts = fluxo.monitoring.config.blockedHosts;
    ...
    isBlockedMime: function (mimeType) {
        var blockedMimeList = fluxo.monitoring.config.blockedMimeList;
    ...
    hasMatchingExtension: function (file) {
        ...
        if (ext) {
            var fileExts = fluxo.monitoring.config.fileExts;
    ...
    isVideoMime: function (mimeText) {
        var mimeList = fluxo.monitoring.config.mimeList;
        if (!mimeList) {
            return false;
        }
    ...
    isKnownStreamingUrl: function (url) {
        var videoUrls = fluxo.monitoring.config.videoUrls;
        if (!videoUrls) {
            return false;
        }
    ...
    hasVideoFileExtension: function (url) {
        var vidExts = fluxo.monitoring.config.vidExts;
